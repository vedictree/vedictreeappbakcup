...
public class ActivitySessionAdapter extends RecyclerView.Adapter <ActivitySessionAdapter.ViewHolder>{
    ...
    public ActivitySessionAdapter(Context context, ArrayList<String> session_name, ArrayList<String> session_image,ArrayList<String> video_id,ArrayList<String> session_id,ArrayList<String> video_type) {
        super();
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, @SuppressLint("RecyclerView") int i) {
        ...
        if (sessionImage.get(i).isEmpty()){

        }else {
            CircularProgressDrawable circularProgressDrawable =new CircularProgressDrawable(viewHolder.session_image_new.getContext());
            ...
            Glide.with(viewHolder.session_image_new.getContext())
                    .asBitmap()
                    .load("https://www.vedictreeschool.com/uploads/valueImage/" + sessionImage.get(i))
        ...
        Log.i("https://www.vedictreeschool.com/uploads/valueImage/",sessionImage.get(i));

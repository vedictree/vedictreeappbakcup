...
public class CourseShining extends AppCompatActivity implements View.OnClickListener{
...
//    MusicManager mm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_shining);
...
//        }
            ...
            public void onResponse(Call<Login_token> call, Response<Login_token> response) {
                if (response.body() != null) {
                    ...
                    if(login_token.getCode().equals(200)){
                        ...
                        Intent login_intent=new Intent(CourseShining.this, LoginActivity.class);
        ...
        mAnnualFee=findViewById(R.id.shin_annual_fee);
        mGST=findViewById(R.id.shin_gst);
        mbook=findViewById(R.id.shin_book);
        mTotalFee=findViewById(R.id.shin_total_fee);
        mTotalAmount=findViewById(R.id.shin_total_amount);
        mCourse=findViewById(R.id.shin_course);
        showVideo=(TextView)this.findViewById(R.id.show_shin);
        showPdf=findViewById(R.id.pdf_shin);
        showPdf.setOnClickListener(this);
        showVideo.setOnClickListener(this);
        mBack=findViewById(R.id.course_shin_back);
        mTopImage=findViewById(R.id.coures_shining_top);
...
//        course_name=preferences.getString("COURSE_NAME","");
        ...
        if (course_name.equals("Nursery")){
            amount_str="14999";
            mAnnualFee.setText("27,698/-");
            mbook.setText("2,300/-");
            mGST.setText("14,999/-");
            mTotalAmount.setText("14,999/-");
            mTotalFee.setText("29,998/-");
            package_name_str="Shining Star (Nursery)";
            planId="3";
        }
        else if (course_name.equals("Senior")){
            amount_str="16999";
            mAnnualFee.setText("31,698/-");
            mbook.setText("2,300/-");
            mGST.setText("16,999/-");
            mTotalAmount.setText("16,999/-");
            mTotalFee.setText("33,998/-");
            package_name_str="Shining Star (Senior)";
            planId="13";
        }
        else if (course_name.equals("Junior")){
            amount_str="15999";
            mAnnualFee.setText("23,698/-");
            mbook.setText("2,300/-");
            mGST.setText("15,999/-");
            mTotalAmount.setText("15,999/-");
            mTotalFee.setText("31,998/-");
            package_name_str="Shining Star (Junior)";
            planId="8";
        }
        mPayNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mMyCourseFrom.equals("profile")){
                    ...
                    editor.putString("PKG_NAME", "shine");
                    editor.putString("PALN_ID", planId);
                    editor.commit();
                    Intent intent = new Intent(CourseShining.this, PaymentMode.class);
        ...
        Glide.with(mTopImage.getContext())
                .load("https://www.vedictreeschool.com/vtmobapp/images/ic_shin_top.png")
...
//        getUrl(url);
        AlertDialog.Builder builder = new AlertDialog.Builder(CourseShining.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialog = LayoutInflater.from(CourseShining.this).inflate(R.layout.progress_layout, viewGroup, false);
        builder.setView(dialog);
        alert_video= builder.create();
        alert_video.show();

        if (course_name.equals("Nursery")){
            String video_id="562686881";
            String url="https://player.vimeo.com/video/"+video_id+"/config";
            getUrl(url);

        }else if (course_name.equals("Junior")){
            String video_id="562687336";
            String url="https://player.vimeo.com/video/"+video_id+"/config";
            getUrl(url);
        }else if (course_name.equals("Senior")){
            String video_id="562687754";
            String url="https://player.vimeo.com/video/"+video_id+"/config";
            getUrl(url);
        }
...
//                    Log.i("Url",str_url);
                    ...
                    Intent intent=new Intent(CourseShining.this, VideoPlayerDemoVideoPlayer.class);

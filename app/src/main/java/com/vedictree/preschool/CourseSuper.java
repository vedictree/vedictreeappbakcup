...
public class CourseSuper extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_super);
        ...
        mPayNow=findViewById(R.id.super_pay_now);
        ...
        if (plan_id.equals("16")||plan_id.equals("15")|plan_id.equals("10")){
...
//        }
            ...
            public void onResponse(Call<Login_token> call, Response<Login_token> response) {
                if (response.body() != null) {
                    ...
                    if(login_token.getCode().equals(200)){
                        ...
                        Intent login_intent=new Intent(CourseSuper.this, LoginActivity.class);
        ...
        mAnnualFee=findViewById(R.id.super_annual_fee);
        mGST=findViewById(R.id.super_gst);
        mbook=findViewById(R.id.super_book);
        mTotalFee=findViewById(R.id.super_total_fee);
        mTotalAmount=findViewById(R.id.super_total_amoun);
        mCourse=findViewById(R.id.super_course);
        showVideo=findViewById(R.id.show_super);
        showPdf=findViewById(R.id.pdf_super);
        mBack=findViewById(R.id.course_super_back);
        showVideo.setOnClickListener(this);
        showPdf.setOnClickListener(this);
        mBack.setOnClickListener(this);
        mTopImage=findViewById(R.id.courses_super_top);
...
//        course_name=preferences.getString("COURSE_NAME","");
        ...
        if (course_name.equals("Nursery")){
            amount_str="31999";
            mAnnualFee.setText("61,698/-");
            mbook.setText("2,300/-");
            mGST.setText("31,999/-");
            mTotalAmount.setText("31,999/-");
            mTotalFee.setText("63,998/-");
            package_name_str="Super Star (Nursery)";
            planId="16";
        }
        else if (course_name.equals("Senior")){
            amount_str="33999";
            mAnnualFee.setText("65,698/-");
            mbook.setText("2,300/-");
            mGST.setText("33,999/-");
            mTotalAmount.setText("33,999/-");
            mTotalFee.setText("67,998/-");
            package_name_str="Super Star (Senior)";
            planId="15";
        }
        else if (course_name.equals("Junior")){
            amount_str="32999";
            mAnnualFee.setText("63,698/-");
            mbook.setText("2,300/-");
            mGST.setText("32,999/-");
            mTotalFee.setText("65,998/-");
            mTotalAmount.setText("32,999/-");
            package_name_str="Super Star (Junior)";
            planId="10";
        }
        mPayNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mMyCourseFrom.equals("profile")){
                    ...
                    editor.putString("PKG_NAME", "super");
                    editor.putString("PALN_ID", planId);

                    editor.commit();
                    Intent intent = new Intent(CourseSuper.this, PaymentMode.class);
        ...
        Glide.with(mTopImage.getContext())
                .load("https://www.vedictreeschool.com/vtmobapp/images/ic_super_image_top.png")
...
//        mm.stop();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.show_super:
                showVideoView(view);
                break;
            case R.id.pdf_super:
                editor.putString("PACKAGE_NAME","SUPER");
                editor.commit();
                Intent intent = new Intent(getApplicationContext(), PdfView.class);
                startActivity(intent);
//                CopyReadPDFFromAssets();
                break;
            case R.id.course_super_back:
                finish();
            default:break;
        }
    }
...
//        getUrl(url);
        ...
        if (course_name.equals("Nursery")){
            ...
            String video_id="562688607";
            String url="https://player.vimeo.com/video/"+video_id+"/config";
            getUrl(url);
        }else if (course_name.equals("Senior")){
            String video_id="562689077";
            String url="https://player.vimeo.com/video/"+video_id+"/config";
            getUrl(url);
        }
    }
...
//                    Log.i("Url",str_url);
                    ...
                    Intent intent=new Intent(CourseSuper.this, VideoPlayerDemoVideoPlayer.class);

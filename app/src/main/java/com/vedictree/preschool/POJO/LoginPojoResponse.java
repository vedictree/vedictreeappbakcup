...
public class LoginPojoResponse {
    ...
    @SerializedName("logRandomId")
    @Expose
    private String logRandomId;
    ...
    public String getUserAbtInfo() {
        return userAbtInfo;
    }

    public void setUserAbtInfo(String userAbtInfo) {
    ...
    public String getUnlock_monthId() {
        return unlock_monthId;
    }

    public void setUnlock_monthId(String unlock_monthId) {
        this.unlock_monthId = unlock_monthId;
    }
    ...
    public String getLogRandomId(){
        return logRandomId;
    }

    public void setLogRandomId(String logRandomId){
        this.logRandomId=logRandomId;
    }
}

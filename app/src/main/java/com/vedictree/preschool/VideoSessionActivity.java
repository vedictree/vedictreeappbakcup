...
public class VideoSessionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    RecyclerView.LayoutManager StoryCraftLayoutManager;

    SessionAdapter sessionAdapter;
//    ArrayList<String> session_name;
//    ArrayList<Integer> session_button_image;
...
//    ArrayList<Integer> curriculum_session_button_image;
//    ArrayList<Integer> image_array;
            ...
            public void onResponse(Call<Login_token> call, Response<Login_token> response) {
                if (response.body() != null) {
                    ...
                    if(login_token.getCode().equals(200)){
                        ...
                        Intent login_intent=new Intent(VideoSessionActivity.this, LoginActivity.class);
...
//                        mediaPlayer.stop();
        ...
        mLogo=findViewById(R.id.video_session_logo);
        mHome=findViewById(R.id.session_video_day_home);
        mVideo=findViewById(R.id.session_vide_video_text);
        mVideoSessionName=findViewById(R.id.session_video_subject_text);
        mMonthButton=findViewById(R.id.session_month);
        mDayButton=findViewById(R.id.session_day);
        mDayMonthll=findViewById(R.id.session_day_month_ll);
        mStoryCraftll=findViewById(R.id.session_story_craft_ll);
        SessionVideoll=findViewById(R.id.session_video_layout);
        mMonth=findViewById(R.id.session_video_month_button);
        mDay=findViewById(R.id.session_video_day_button);

        mStoryButton=findViewById(R.id.story_button);
        mStoryImage=findViewById(R.id.story_image);
        mCraftButton=findViewById(R.id.craft_button);
        mCraftImage=findViewById(R.id.craft_image);

        SessionVideoll.setVisibility(View.VISIBLE);
        mStoryCraftll.setVisibility(View.GONE);
        mDayMonthll.setVisibility(View.VISIBLE);

        ExtraCurriculumRecyclerView=findViewById(R.id.extra_curriculum_recyclerview_2);
        CurriculumRecylerview=findViewById(R.id.curriculum_recyclerview_2);
        MorningRecyclerView=findViewById(R.id.morning_recyclerview_2);
        StoryRecyclerView =findViewById(R.id.story_recyclerview);

        mCurriculam_ll=findViewById(R.id.curriculum_ll_2);
        mExtra_curriculaum_ll=findViewById(R.id.extra_curriculum_ll_2);
        mMorning_ll=findViewById(R.id.morning_ll_2);
...
//        image_array.add(R.drawable.story);
//        image_array.add(R.drawable.gen_aware);
//        image_array.add(R.drawable.concept);
//        image_array.add(R.drawable.hindi);
//        image_array.add(R.drawable.maths);
//        image_array.add(R.drawable.eng_1);
//        image_array.add(R.drawable.rhymes);
//        image_array.add(R.drawable.story);
//        image_array.add(R.drawable.gen_aware);
//        image_array.add(R.drawable.concept);
...
//        image_array.add(R.drawable.eng_1);
        ...
        mMorning_button=findViewById(R.id.session_morning_routine_button);
        mCurriculum_button=findViewById(R.id.session_curriculum);
        mExtra_curriculum_button=findViewById(R.id.session_extra_curriculum);
...
//        sessionAdapter = new SessionAdapter(getApplicationContext(),morning_session_name,morning_session_image,morning_session_video_id,morning_session_sessionid,session_background,session_background_two);
...
//        sessionAdapter = new SessionAdapter(getApplicationContext(), curriculum_session_name, image_array,curriculum_session_video_id,curriculum_session_sessionid);
        ...
        mVideoSessionName.setOnClickListener(this);
                            ...
                            try {
                                ...
                                if (date_diff.equals("0")) {
                                    ...
                                    if (match_string.equals("Match")) {
                                        ...
                                        Window window = VideoSessionActivity.this.getWindow();
                                        window.getDecorView().getWindowVisibleDisplayFrame(displayRectangle);
                                        AlertDialog.Builder builder = new AlertDialog.Builder(VideoSessionActivity.this);
                                        ViewGroup viewGroup = findViewById(android.R.id.content);
                                        View dialog = LayoutInflater.from(VideoSessionActivity.this).inflate(R.layout.live_sessions_pop_up, viewGroup, false);
                                            ...
                                            public void onClick(View view) {
                                                ...
                                                if (app_name.equals("Youtube app.")) {
                                                    ...
                                                    if (matcher.find()) {
                                                        ...
                                                        editor.commit();
                                                        Intent webIntent1 = new Intent(VideoSessionActivity.this, YouTubeVideo.class);
                                                        startActivity(webIntent1);
                                                    } else {
                            ...
                            if (note_array.isEmpty()) {
                                ...
                                button.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        yes_button.start();
                                        alertDialog.dismiss();
                                        Intent intent=new Intent(VideoSessionActivity.this,NotificationActivity.class);
...
//                Toast.makeText(context, t.getMessage(), Toast.LENGTH_LONG).show();
    ...
    private void checkPreviousMonthAccess() {
        String studetn_id=preferences.getString("STUDENT_ID","");
        APIInterface service = RetrofitSignletonTeacher.getLiveIntrface();
        Call<AccessPreviousMonth> call = service.checkPreviousMonth(studetn_id);
        call.enqueue(new Callback<AccessPreviousMonth>() {
            @Override
            public void onResponse(Call<AccessPreviousMonth> call, Response<AccessPreviousMonth> response) {
                if (response.body() != null) {
                    Log.i("Message is",response.body().getMsg());
                    if (response.body().getMsg().equals(" access denied !")){
                        editor.putString("ACCESS_GRAND","No");
                        editor.commit();
                    }else {
                        editor.putString("ACCESS_GRAND", "Yes");
                        editor.commit();
                    }
                }
            }
            ...
            @Override
            public void onFailure(Call<AccessPreviousMonth> call, Throwable t) {
            }
        });
    }
...
//                Toast.makeText(getApplicationContext(), t.getMessage(), Toast.LENGTH_LONG).show();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.session_video_day_home:
                ...
                day_home_anim.start();
                Intent intent=new Intent(VideoSessionActivity.this,ChildeDashboardNew.class);
                startActivity(intent);
                finish();
//                mediaPlayer.stop();
                break;

            case R.id.session_vide_video_text:
                ...
                day_video_anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    @Override
                    public void onAnimationUpdate(ValueAnimator animation) {
                        mVideo.setScaleX((Float) animation.getAnimatedValue());
                        mVideo.setScaleY((Float) animation.getAnimatedValue());
                    }
                });
                day_video_anim.setRepeatCount(1);
                day_video_anim.setRepeatMode(ValueAnimator.REVERSE);
                day_video_anim.start();
                Intent home_intent=new Intent(VideoSessionActivity.this,VideoMonthDayActivity.class);
                startActivity(home_intent);
                finish();
//                mediaPlayer.stop();
                break;

            case R.id.session_video_subject_text:
                ...
                day_subject_anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    @Override
                    public void onAnimationUpdate(ValueAnimator animation) {
                        mVideoSessionName.setScaleX((Float) animation.getAnimatedValue());
                        mVideoSessionName.setScaleY((Float) animation.getAnimatedValue());
                    }
                });
                day_subject_anim.setRepeatCount(1);
                day_subject_anim.setRepeatMode(ValueAnimator.REVERSE);
                day_subject_anim.start();
                mDayMonthll.setVisibility(View.INVISIBLE);
                SessionVideoll.setVisibility(View.GONE);
                mStoryCraftll.setVisibility(View.VISIBLE);
                setStoryCraftVideo();

                break;

            case R.id.session_morning_routine_button:
...
//                sessionAdapter = new SessionAdapter(getApplicationContext(),morning_session_name,image_array,morning_session_video_id,morning_session_video_id);
            ...
            case R.id.session_extra_curriculum:
                mMorning_button.setAlpha(0.7f);
                mCurriculum_button.setAlpha(0.7f);
            ...
            case R.id.story_button:
                ...
                editor.commit();
//                mStoryButton.startAnimation(AnimationUtils.loadAnimation(VideoSessionActivity.this, R.anim.shake));
                intent=new Intent(VideoSessionActivity.this,VideoSessionStoryCraft.class);
                startActivity(intent);
                break;
            case R.id.story_image:
                editor.putString("STORY_OR_CRAFT","STORY");
                editor.commit();
                mStoryImage.startAnimation(AnimationUtils.loadAnimation(VideoSessionActivity.this, R.anim.shake));
                intent=new Intent(VideoSessionActivity.this,VideoSessionStoryCraft.class);
                startActivity(intent);
                break;
            case R.id.craft_button:
                ...
                editor.commit();
//                mCraftButton.startAnimation(AnimationUtils.loadAnimation(VideoSessionActivity.this, R.anim.shake));
                intent=new Intent(VideoSessionActivity.this,VideoSessionStoryCraft.class);
                startActivity(intent);
                break;
            case R.id.craft_image:
                editor.putString("STORY_OR_CRAFT","CRAFT");
                editor.commit();
                mCraftImage.startAnimation(AnimationUtils.loadAnimation(VideoSessionActivity.this, R.anim.shake));
                intent=new Intent(VideoSessionActivity.this,VideoSessionStoryCraft.class);
                startActivity(intent);
                break;

            case R.id.session_video_day_button:
                intent=new Intent(VideoSessionActivity.this,VideoMonthDayActivity.class);
                editor.putString("CAL_MONTH","day");
                editor.commit();
                startActivity(intent);
                finish();
//                mediaPlayer.stop();
            ...
            case R.id.session_video_month_button:
                intent=new Intent(VideoSessionActivity.this,VideoMonthDayActivity.class);
                editor.putString("CAL_MONTH","month");
                editor.commit();
                startActivity(intent);
                finish();
//                mediaPlayer.stop();
    ...
    private void setStoryCraftVideo() {
         session_name.clear();
          session_video_id.clear();
         session_sessionid.clear();
         session_video_type.clear();
         session_image.clear();
                    ...
                    if (weeklyDataDetailList!=null){
                        for (int i=0;i<weeklyDataDetailList.size();i++){
                            if (weeklyDataDetailList.get(i).getYoutubelink().equals("")){
                                session_video_id.add(weeklyDataDetailList.get(i).getVimeoId());
                                 session_video_type.add("Vimeo");
                            }else {
                                 session_video_id.add(weeklyDataDetailList.get(i).getYoutubelink());
                                 session_video_type.add("Youtube");
                            }
                             session_name.add(weeklyDataDetailList.get(i).getStoryTitle());
//                             session_image.add(weeklyDataDetailList.get(i).getSessionImage());
                        }
                    }

                    if ( session_name!=null) {
                        StoryRecyclerView.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
...
//                        activitySessionAdapter = new StorySessionAdapter(getApplicationContext(),session_name,session_image,session_video_id,session_sessionid, image_array,session_background_two,session_video_type);
                        StoryRecyclerView.setAdapter(activitySessionAdapter);
                    }else {
                    }
                } else {

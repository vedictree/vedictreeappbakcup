...
public class TermsAndConditionsNew extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.terms_and_conditions_new);
                ...
                public void onResponse(Call<Login_token> call, Response<Login_token> response) {
                    if (response.body() != null) {
                        ...
                        if (login_token.getCode().equals(200)) {
                            ...
                            Intent login_intent = new Intent(TermsAndConditionsNew.this, LoginActivity.class);
        ...
        mBack=findViewById(R.id.t_c_back_to_home_button);
        mLogo=findViewById(R.id.t_c_logo);
